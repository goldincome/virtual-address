...
@section('title', 'Create Virtual Address Plan')
@section('content')
        ...
        <main class="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div class="w-full max-w-3xl bg-white shadow-xl rounded-lg overflow-hidden">
                <div class="px-8 py-6 border-b border-gray-200">
                    <h2 class="text-2xl font-bold text-blue-800">Create New Plan</h2>
                </div>

                <form method="POST" enctype="multipart/form-data" action="{{ route('admin.plans.store') }}"
                    class="p-8 space-y-6">
                    @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" rows="2"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-orange-500 focus:border-orange-500">{{ old('description') }}</textarea>
                        </div>

                        <div>
                            <label for="price"
                                class="block text-sm font-medium text-gray-700 mb-2">Paid Monthly Price({{ config('cashier.currency') }})</label>
                            <div class="relative">
                        ...
                        <div>
                            <label for="yearly_monthly_price"
                                class="block text-sm font-medium text-gray-700 mb-2">Paid Yearly Monthly Price({{ config('cashier.currency') }})</label>
                            <div class="relative">
                                <span class="absolute inset-y-0 left-0 pl-3 flex items-center text-gray-500">

                                </span>
                                <input type="number" step="0.01" id="yearly_monthly_price" name="yearly_monthly_price" required
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="1" id="level" name="level" required value="{{ old('level') }}"
