...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | This is the model in your application that represents a subscription and
    | holds a reference to the subscription's owner. You may extend this
    | model and set this value to your extended model's class name.
    |
    */

    'subscription_model' => App\Models\PlanSubscription::class,
